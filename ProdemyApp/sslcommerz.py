...
def sslcommerz_payment_gateway(request, name, amount):
    ...
    cradentials = {'store_id': 'prode659a2d20cb160',
            'store_pass': 'prode659a2d20cb160@ssl', 'issandbox': True}
    ...
    body['success_url'] = 'http://localhost:8007/account/payment/success/'
    body['fail_url'] = 'http://localhost:8007/account/payment/payment/faild/'
    body['cancel_url'] = 'http://localhost:8007/account/payment'
    body['emi_option'] = 0
    body['cus_name'] = name
