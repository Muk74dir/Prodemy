...
def sslcommerz_payment_gateway(request, name, amount):
    ...
    body['success_url'] = 'http://localhost:8003/payment/success/'
    body['fail_url'] = 'http://localhost:8003/payment/payment/faild/'
    body['cancel_url'] = 'http://localhost:8003/payment'
    body['emi_option'] = 0
    body['cus_name'] = name
